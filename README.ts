...
## Dogfooding
The [README.md](README.md) you are looking at was also made using \`${projectName}\`, although it's not a complex example, it proves the concept is valid at a small scale.
